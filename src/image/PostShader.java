...
public class PostShader extends ShaderProgram {
	private static String VERT_FILE = MusicController.SHADER_PATH + "/shaders/postVertex.shader",
			FRAG_FILE = MusicController.SHADER_PATH + "/shaders/postFragment.shader";
